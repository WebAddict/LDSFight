...
"C:\Development\adt-bundle\sdk\build-tools\23.0.3\zipalign.exe" -f -v 4 "C:\apps\LDSFight\platforms\android\build\outputs\apk\android-release-unsigned.apk" "C:\apps\LDSFight\platforms\android\build\outputs\apk\LDSFight-1.1.6.apk"
